...
public class ClientActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        bt_setprop_true.setOnClickListener(view -> {
            sendData(Constant.SET_TRUE);
        });

        bt_setprop_false.setOnClickListener(view -> {
            sendData(Constant.SET_FALSE);
        });

        bt_getprop_status.setOnClickListener(view -> {
