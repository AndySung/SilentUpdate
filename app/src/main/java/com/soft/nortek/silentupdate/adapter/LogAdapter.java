package com.soft.nortek.silentupdate.adapter;
...
public class LogAdapter extends RecyclerView.Adapter<LogAdapter.ItemHolder> {
    ...
    public ItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ItemHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.data_item, parent, false));
    }
    ...
    public class ItemHolder extends RecyclerView.ViewHolder {
        ...
        public ItemHolder(View itemView) {
            ...
            mLog = itemView.findViewById(R.id.log_text_view);
        }
    }
